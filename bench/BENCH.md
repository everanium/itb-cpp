...
`enc.set_lock_batch(1)`) batches the per-chunk Lock Soup overlay
...
| Hash | Width | Crypto | Encrypt | Decrypt | Encrypt + MAC | Decrypt + MAC |
|---|---|---|---|---|---|---|
| **Areion-SoEM-256** | 256 | PRF | 87 | 124 | 100 | 121 |
| **Areion-SoEM-512** | 512 | PRF | 115 | 137 | 110 | 133 |
| **BLAKE2b-256** | 256 | PRF | 64 | 71 | 62 | 70 |
| **BLAKE2b-512** | 512 | PRF | 91 | 103 | 87 | 101 |
| **BLAKE2s** | 256 | PRF | 67 | 75 | 65 | 73 |
| **BLAKE3** | 256 | PRF | 72 | 80 | 71 | 79 |
| **AES-CMAC** | 128 | PRF | 92 | 107 | 89 | 105 |
| **SipHash-2-4** | 128 | PRF | 82 | 94 | 79 | 93 |
| **ChaCha20** | 256 | PRF | 68 | 76 | 66 | 75 |
| **Mixed** | 256 | PRF | 50 | 53 | 47 | 56 |

### ITB Triple 1024-bit (security: P × 2^(3×1024) = P × 2^3072)

| Hash | Width | Crypto | Encrypt | Decrypt | Encrypt + MAC | Decrypt + MAC |
|---|---|---|---|---|---|---|
| **Areion-SoEM-256** | 256 | PRF | 132 | 196 | 162 | 189 |
| **Areion-SoEM-512** | 512 | PRF | 194 | 220 | 178 | 211 |
| **BLAKE2b-256** | 256 | PRF | 82 | 87 | 80 | 84 |
| **BLAKE2b-512** | 512 | PRF | 129 | 140 | 123 | 135 |
| **BLAKE2s** | 256 | PRF | 88 | 93 | 86 | 92 |
| **BLAKE3** | 256 | PRF | 97 | 107 | 95 | 104 |
| **AES-CMAC** | 128 | PRF | 150 | 167 | 143 | 162 |
| **SipHash-2-4** | 128 | PRF | 125 | 133 | 117 | 131 |
| **ChaCha20** | 256 | PRF | 90 | 94 | 86 | 91 |
